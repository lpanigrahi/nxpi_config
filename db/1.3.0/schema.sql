...
\restrict f0ZpokqtazDkIu5Drh59oZbqdNdCVLRlR9LDaBodKLgfwwner2c3JGdxfIpX8NX
...
ALTER TABLE ONLY public.assistant FORCE ROW LEVEL SECURITY;
...
ALTER TABLE ONLY public.knowledge_embedding_migration_state FORCE ROW LEVEL SECURITY;
...
--
-- Name: knowledge_embeddings knowledge_embeddings_dims_col_ck; Type: CHECK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE public.knowledge_embeddings
    ADD CONSTRAINT knowledge_embeddings_dims_col_ck CHECK ((((dims = 1536) AND (embedding IS NOT NULL) AND (embedding_768 IS NULL) AND (embedding_1024 IS NULL) AND (embedding_3072 IS NULL)) OR ((dims = 768) AND (embedding_768 IS NOT NULL) AND (embedding IS NULL) AND (embedding_1024 IS NULL) AND (embedding_3072 IS NULL)) OR ((dims = 1024) AND (embedding_1024 IS NOT NULL) AND (embedding IS NULL) AND (embedding_768 IS NULL) AND (embedding_3072 IS NULL)) OR ((dims = 3072) AND (embedding_3072 IS NOT NULL) AND (embedding IS NULL) AND (embedding_768 IS NULL) AND (embedding_1024 IS NULL)))) NOT VALID;
...
--
-- Name: assistant skill_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: assistant_team skill_team_skill_id_team_id_pk; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.assistant_team
    ADD CONSTRAINT skill_team_skill_id_team_id_pk PRIMARY KEY (assistant_id, team_id);
...
--
-- Name: skill_install tool_install_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: skill_install tool_install_tool_id_user_id_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.skill_install
    ADD CONSTRAINT tool_install_tool_id_user_id_unique UNIQUE (skill_id, user_id);


--
-- Name: skill tool_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: skill_rating tool_rating_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: skill_rating tool_rating_tool_id_user_id_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.skill_rating
    ADD CONSTRAINT tool_rating_tool_id_user_id_unique UNIQUE (skill_id, user_id);


--
-- Name: skill_submission tool_submission_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
ALTER TABLE ONLY public.inference_request_log
    ADD CONSTRAINT inference_request_log_skill_id_skill_id_fk FOREIGN KEY (assistant_id) REFERENCES public.assistant(id) ON DELETE SET NULL;
...
--
-- Name: semantic_response_cache semantic_response_cache_organization_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.semantic_response_cache
    ADD CONSTRAINT semantic_response_cache_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organization(id) ON DELETE CASCADE;
...
--
-- Name: assistant skill_agent_id_agent_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: assistant skill_created_by_user_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: assistant skill_knowledge_base_id_knowledge_base_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: assistant skill_organization_id_organization_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: assistant skill_prompt_version_id_prompt_version_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: assistant skill_reviewed_by_user_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: assistant skill_team_id_team_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: assistant_team skill_team_skill_id_skill_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.assistant_team
    ADD CONSTRAINT skill_team_skill_id_skill_id_fk FOREIGN KEY (assistant_id) REFERENCES public.assistant(id) ON DELETE CASCADE;


--
-- Name: assistant_team skill_team_team_id_team_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: skill_install tool_install_tool_id_tool_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.skill_install
    ADD CONSTRAINT tool_install_tool_id_tool_id_fk FOREIGN KEY (skill_id) REFERENCES public.skill(id) ON DELETE CASCADE;


--
-- Name: skill_install tool_install_user_id_user_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: skill tool_organization_id_organization_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: skill_rating tool_rating_tool_id_tool_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.skill_rating
    ADD CONSTRAINT tool_rating_tool_id_tool_id_fk FOREIGN KEY (skill_id) REFERENCES public.skill(id) ON DELETE CASCADE;


--
-- Name: skill_rating tool_rating_user_id_user_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: skill_submission tool_submission_reviewed_by_user_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: skill_submission tool_submission_tool_id_tool_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.skill_submission
    ADD CONSTRAINT tool_submission_tool_id_tool_id_fk FOREIGN KEY (skill_id) REFERENCES public.skill(id) ON DELETE CASCADE;


--
-- Name: skill_submission tool_submission_user_id_user_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: skill tool_user_id_user_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: assistant; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.assistant ENABLE ROW LEVEL SECURITY;

--
-- Name: knowledge_embedding_migration_state; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.knowledge_embedding_migration_state ENABLE ROW LEVEL SECURITY;

--
-- Name: assistant tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY tenant_isolation ON public.assistant USING ((organization_id = (NULLIF(current_setting('app.current_org_id'::text, true), ''::text))::uuid)) WITH CHECK ((organization_id = (NULLIF(current_setting('app.current_org_id'::text, true), ''::text))::uuid));


--
-- Name: knowledge_embedding_migration_state tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY tenant_isolation ON public.knowledge_embedding_migration_state USING (((organization_id = (NULLIF(current_setting('app.current_org_id'::text, true), ''::text))::uuid) OR ((organization_id IS NULL) AND (user_id = (NULLIF(current_setting('app.current_user_id'::text, true), ''::text))::uuid)))) WITH CHECK (((organization_id = (NULLIF(current_setting('app.current_org_id'::text, true), ''::text))::uuid) OR ((organization_id IS NULL) AND (user_id = (NULLIF(current_setting('app.current_user_id'::text, true), ''::text))::uuid))));
...
\unrestrict f0ZpokqtazDkIu5Drh59oZbqdNdCVLRlR9LDaBodKLgfwwner2c3JGdxfIpX8NX
