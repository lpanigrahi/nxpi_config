...
\restrict 8QBHtdsyaSxj7ZnY6NKyehn55PYN3Z1SCTAMcAFZa9fT42Sz83CfRQVyYlHtWCC
...
CREATE TABLE public.agent (
    ...
    CONSTRAINT agent_visibility_check CHECK (((visibility)::text = ANY (ARRAY[('public'::character varying)::text, ('private'::character varying)::text, ('readonly'::character varying)::text, ('team'::character varying)::text, ('organization'::character varying)::text, ('official'::character varying)::text])))
);
...
CREATE TABLE public.assistant (
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    CONSTRAINT assistant_visibility_check CHECK (((visibility)::text = ANY (ARRAY[('private'::character varying)::text, ('team'::character varying)::text, ('org'::character varying)::text, ('official'::character varying)::text])))
);
...
CREATE TABLE public.knowledge_base (
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    CONSTRAINT knowledge_base_visibility_check CHECK (((visibility)::text = ANY (ARRAY[('private'::character varying)::text, ('team'::character varying)::text, ('org'::character varying)::text, ('public'::character varying)::text])))
);
...
CREATE TABLE public.marketplace_listing (
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    CONSTRAINT marketplace_listing_resource_type_check CHECK (((resource_type)::text = ANY (ARRAY[('agent'::character varying)::text, ('skill'::character varying)::text, ('workflow'::character varying)::text, ('assistant'::character varying)::text, ('prompt'::character varying)::text, ('knowledge_pack'::character varying)::text]))),
    CONSTRAINT marketplace_listing_scope_check CHECK (((scope)::text = ANY (ARRAY[('personal'::character varying)::text, ('team'::character varying)::text, ('organization'::character varying)::text, ('enterprise'::character varying)::text, ('public'::character varying)::text])))
);
...
CREATE TABLE public.memory_entry (
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    CONSTRAINT memory_entry_scope_check CHECK (((scope)::text = ANY (ARRAY[('working'::character varying)::text, ('session'::character varying)::text, ('long_term'::character varying)::text, ('team'::character varying)::text, ('organization'::character varying)::text])))
);
...
CREATE TABLE public.nav_visibility_override (
    ...
    CONSTRAINT nav_visibility_override_scope_check CHECK (((scope)::text = ANY (ARRAY[('global'::character varying)::text, ('org'::character varying)::text])))
);
...
CREATE TABLE public.orchestration_run (
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    completed_at timestamp without time zone,
    CONSTRAINT orchestration_run_status_check CHECK (((status)::text = ANY (ARRAY[('running'::character varying)::text, ('completed'::character varying)::text, ('failed'::character varying)::text])))
);
...
CREATE TABLE public.org_policy (
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    CONSTRAINT org_policy_effect_check CHECK (((effect)::text = ANY (ARRAY[('allow'::character varying)::text, ('deny'::character varying)::text]))),
    CONSTRAINT org_policy_type_check CHECK (((type)::text = ANY (ARRAY[('governance'::character varying)::text, ('security'::character varying)::text, ('compliance'::character varying)::text, ('ownership'::character varying)::text])))
);
...
CREATE TABLE public.prompt_template (
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    CONSTRAINT prompt_template_visibility_check CHECK (((visibility)::text = ANY (ARRAY[('private'::character varying)::text, ('org'::character varying)::text, ('public'::character varying)::text])))
);
...
CREATE TABLE public.skill (
    ...
    CONSTRAINT skill_lifecycle_status_check CHECK (((lifecycle_status)::text = ANY (ARRAY[('draft'::character varying)::text, ('pending'::character varying)::text, ('approved'::character varying)::text, ('rejected'::character varying)::text, ('disabled'::character varying)::text, ('deprecated'::character varying)::text, ('retired'::character varying)::text, ('archived'::character varying)::text]))),
    CONSTRAINT skill_scope_check CHECK (((scope)::text = ANY (ARRAY[('personal'::character varying)::text, ('team'::character varying)::text, ('organization'::character varying)::text]))),
    CONSTRAINT skill_visibility_check CHECK (((visibility)::text = ANY (ARRAY[('public'::character varying)::text, ('private'::character varying)::text, ('readonly'::character varying)::text])))
);
...
CREATE TABLE public.skill_qa_certification (
    ...
    revoked_by uuid,
    revoked_reason text,
    CONSTRAINT skill_qa_certification_tier_check CHECK (((tier)::text = ANY (ARRAY[('none'::character varying)::text, ('bronze'::character varying)::text, ('silver'::character varying)::text, ('gold'::character varying)::text, ('enterprise'::character varying)::text])))
);
...
CREATE TABLE public.skill_qa_check_result (
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    CONSTRAINT skill_qa_check_result_status_check CHECK (((status)::text = ANY (ARRAY[('pass'::character varying)::text, ('warn'::character varying)::text, ('fail'::character varying)::text, ('skipped'::character varying)::text, ('error'::character varying)::text])))
);
...
CREATE TABLE public.skill_qa_run (
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    fingerprint json,
    CONSTRAINT skill_qa_run_enforcement_check CHECK (((enforcement_mode)::text = ANY (ARRAY[('advisory'::character varying)::text, ('enforcing'::character varying)::text]))),
    CONSTRAINT skill_qa_run_score_check CHECK (((quality_score >= 0) AND (quality_score <= 100))),
    CONSTRAINT skill_qa_run_status_check CHECK (((status)::text = ANY (ARRAY[('passed'::character varying)::text, ('failed'::character varying)::text, ('degraded'::character varying)::text, ('skipped'::character varying)::text]))),
    CONSTRAINT skill_qa_run_tier_check CHECK (((tier)::text = ANY (ARRAY[('static'::character varying)::text, ('live'::character varying)::text]))),
    CONSTRAINT skill_qa_run_trigger_check CHECK (((trigger)::text = ANY (ARRAY[('publish'::character varying)::text, ('save'::character varying)::text, ('approval'::character varying)::text, ('manual'::character varying)::text, ('import'::character varying)::text])))
);
...
CREATE TABLE public.skill_scan (
    ...
    scanned_by uuid,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    CONSTRAINT skill_scan_risk_level_check CHECK (((risk_level)::text = ANY (ARRAY[('low'::character varying)::text, ('medium'::character varying)::text, ('high'::character varying)::text, ('critical'::character varying)::text]))),
    CONSTRAINT skill_scan_source_check CHECK (((scan_source)::text = ANY (ARRAY[('import'::character varying)::text, ('save'::character varying)::text, ('approval'::character varying)::text, ('manual'::character varying)::text, ('scheduled'::character varying)::text])))
);
...
CREATE TABLE public.workflow_execution (
    ...
    started_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    completed_at timestamp without time zone,
    CONSTRAINT workflow_execution_status_check CHECK (((status)::text = ANY (ARRAY[('running'::character varying)::text, ('success'::character varying)::text, ('fail'::character varying)::text, ('paused'::character varying)::text, ('cancelled'::character varying)::text])))
);
...
--
-- Name: skill_qa_certification skill_qa_certification_issued_by_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.skill_qa_certification
    ADD CONSTRAINT skill_qa_certification_issued_by_fk FOREIGN KEY (issued_by) REFERENCES public."user"(id) ON DELETE SET NULL;


--
-- Name: skill_qa_certification skill_qa_certification_revoked_by_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.skill_qa_certification
    ADD CONSTRAINT skill_qa_certification_revoked_by_fk FOREIGN KEY (revoked_by) REFERENCES public."user"(id) ON DELETE SET NULL;


--
-- Name: skill_qa_certification skill_qa_certification_run_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.skill_qa_certification
    ADD CONSTRAINT skill_qa_certification_run_id_fk FOREIGN KEY (run_id) REFERENCES public.skill_qa_run(id) ON DELETE SET NULL;


--
-- Name: skill_qa_certification skill_qa_certification_skill_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.skill_qa_certification
    ADD CONSTRAINT skill_qa_certification_skill_id_fk FOREIGN KEY (skill_id) REFERENCES public.skill(id) ON DELETE CASCADE;


--
-- Name: skill_qa_check_result skill_qa_check_result_run_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.skill_qa_check_result
    ADD CONSTRAINT skill_qa_check_result_run_id_fk FOREIGN KEY (run_id) REFERENCES public.skill_qa_run(id) ON DELETE CASCADE;


--
-- Name: skill_qa_check_result skill_qa_check_result_skill_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.skill_qa_check_result
    ADD CONSTRAINT skill_qa_check_result_skill_id_fk FOREIGN KEY (skill_id) REFERENCES public.skill(id) ON DELETE CASCADE;


--
-- Name: skill_qa_recording skill_qa_recording_run_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.skill_qa_recording
    ADD CONSTRAINT skill_qa_recording_run_id_fk FOREIGN KEY (run_id) REFERENCES public.skill_qa_run(id) ON DELETE CASCADE;


--
-- Name: skill_qa_recording skill_qa_recording_skill_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.skill_qa_recording
    ADD CONSTRAINT skill_qa_recording_skill_id_fk FOREIGN KEY (skill_id) REFERENCES public.skill(id) ON DELETE CASCADE;


--
-- Name: skill_qa_run skill_qa_run_requested_by_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.skill_qa_run
    ADD CONSTRAINT skill_qa_run_requested_by_fk FOREIGN KEY (requested_by) REFERENCES public."user"(id) ON DELETE SET NULL;


--
-- Name: skill_qa_run skill_qa_run_skill_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.skill_qa_run
    ADD CONSTRAINT skill_qa_run_skill_id_fk FOREIGN KEY (skill_id) REFERENCES public.skill(id) ON DELETE CASCADE;
...
\unrestrict 8QBHtdsyaSxj7ZnY6NKyehn55PYN3Z1SCTAMcAFZa9fT42Sz83CfRQVyYlHtWCC
